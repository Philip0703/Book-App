...
<form method="POST"><table class="table"><tr>
        ...
        <td>roll number</td>
        <td><input name="roll" class="form-control" type="number"></td>
    </tr><tr>
        <td>admission number</td>
        <td><input name="adm" class="form-control" type="number"></td>
    </tr><tr>
        <td>email id</td>
        ...
        <td>parent mob</td>
        <td><input name="pmob" class="form-control" type="number"></td>
    </tr><tr>
        <td>email id pr</td>
        ...
        <td><input name="cpass" class="form-control" type="password"></td>
    </tr><tr>
        <td></td>
